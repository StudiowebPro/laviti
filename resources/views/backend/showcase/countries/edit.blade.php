...
@section ('title', trans('labels.backend.showcase.countries.management') . ' | ' . trans('labels.backend.showcase.countries.create'))
...
@section('content')
    {{ Form::model($country, ['route' => ['admin.showcase.country.update', $country ], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) }}
