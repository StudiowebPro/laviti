        ...
        'backend'   => [
            'access'    => [
                ...
                'products'                      => [
                    ...
                    'middle_description'        =>  'Промежуточное описание',
                    'description'               =>  'Подробное описание',
                    'main_img'                  =>  'Главное фото',
                    'is_available'              =>  'Доступен',
                    'material'                  =>  'Материал',
                    'is_visible'                =>  'Видим',
                    'is_homepage'               =>  'Показать на главной',
                    'seo_title'                 =>  'Заголовок закладки браузера',
                    'seo_keywords'              =>  'Ключевые слова SEO',
                    'seo_description'           =>  'Описание SEO',
                    'is_new'                    =>  'Показать в новинках',
                    'is_sale'                   =>  'Показать в распродажах',
                    'price_sale'                =>  'Цена на распродаже',
                    'is_action'                 =>  'Участник акции',
                    'is_bonus'                  =>  'Начислять бонус',
                    'sum_bonus'                 =>  'Сумма бонуса',
                    'action_id'                 =>  'Акция со скидками',
                    'bonusaction_id'            =>  'Акция с бонусами',
                    'is_leader'                 =>  'Лидер продаж',
                    'collection_id'             =>  'Коллекция',
                    'is_collection_visible'     =>  'Показать коллекцию',
                ],
            ],
        ],
        'frontend'  => [
